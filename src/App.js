            ...
            <div className="Page__section" ref="jobs">
              ...
              <Job
                ...
                description="Chef de projet d&eacute;veloppement, d&eacute;veloppeur dans le cadre de la
                  ...
                  <ul>
                    <li>Equipe Scrum (8 pers) : Interface Tablette Vendeur, Refonte des sites clients</li>
                    <li>AngularJs, Node JS, Gulp, AWS, MongoDb, Jenkins, Puppet, Gitlab-CI</li>
                    <li>Rôles :
                      <ul>
                        <li>Leader Technique de la feature VENTE (5 développeurs en mode full-stack)</li>
                        <li>Mise en place et dev d'une application (FACE Tablet) pour les vendeurs en popup store en AngularJs 1.5.8</li>
                        <li>Mise en place et dev de la refonte de espaceclient et parcours de vente web en AngularJs 1.6.0</li>
                      </ul>
                    </li>
                  </ul>
              </Job>
              ...
              <Job
                ...
                " >
                <ul>
                  <li>Projets (6 à 15 pers) : Espace Client FAI, EC Unifié, Module Centralisé, Assistance Unifiée</li>
                  <li>PHP5, SOAP, NodeJS, MYSQL5, NGINX, RethinkDb, Responsive, Adaptive, Jquery</li>
                  <li>Rôles :
                    <ul>
                      <li>Développeur au sein des ex-équipes Club Internet, puis Référent technique et CP Dev.</li>
                      <li>Projets web principalement sur le modèle "NGINX/PHP-FPM/WS SOAP Java/Bdd Oracle".</li>
                      <li>Intégration au Club des experts de Bouygues Telecom (Rédaction d'articles internes)</li>
                      <li>Diffusion de la philosophie de développement Fixe sur la partie Mobile de Bouygues Telecom.</li>
                      <li>Outils de stats et d'analyse des sites BigData/Live (RabbitMQ, ElasticSearch, ...).</li>
                      <li>Api REST en NodeJs qui permet d'intéragir avec une base RethinkDb.</li>
                      <li>Header/footer responsive centralisé sur l'ensemble des sites Bouygues Telecom</li>
                      <li>Assistance unifiée (GP, PRO, Desktop, Mobile) et Refontes des EC</li>
                      <li>Finaliste du « Digital Hackaton » avec un sujet d'analyse prédictive de la navigation cliente</li>
                    </ul>
                  </li>
                </ul>
              </Job>
              ...
              <Job
                ...
                " >
                <ul>
                  <li>Projet (5 pers) : Portail du département Hébergeur et Portail du département Production</li>
                  <li>PHP5, MYSQL5, Apache, XHTML, CSS, Ajax, JSON, IIS, SQL SERVER, J2EE, Oracle, XHTML, Ajax, JSON, CSS, Unix, Korn Shell, Prototype, Tomcat</li>
                  <li>Rôles :
                    <ul>
                      <li>Management et développement d'une application Web des indicateurs de QOS.</li>
                      <li>Développeur puis Responsable de l'équipe en charge de la TMA du portail de l'hébergeur</li>
                      <li>Réalisation d'outils web pour faciliter le suivi projet des équipes de Sopra Group</li>
                    </ul>
                  </li>
                </ul>
              </Job>
